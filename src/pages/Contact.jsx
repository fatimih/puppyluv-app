...
function Contact() {
  return (
    <>
      <SEO 
        title="Contact Tima - Puppy Luv San Diego" 
        description="Get in touch to discuss your dog's care and book a meet and greet with Tima, serving San Diego with personalized pet care."
      />
